...
### 2️⃣ Backend (Authoritative Game Server)
...
1. **Rules Knowledge** — Chunked SRD / edition rules, tagged by edition
2. **World Knowledge** — PDF chunks, lore, geography, factions, gods, history
3. **Monster & Spell Reference** — Structured stat blocks
...
### 🟢 MVP (3–4 months realistic build)
